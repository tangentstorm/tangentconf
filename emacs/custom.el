...
")
 ...
 '(package-selected-packages '(magit coffee-mode use-package))
...
(custom-set-faces
 ...
 '(bold ((t (:foreground "darkgray" :weight bold))))
 ...
 '(italic ((t (:foreground "cyan" :slant italic))))
 ...
 '(org-drawer ((t (:foreground "darkslategray"))))
 ...
 '(org-list-dt ((t (:foreground "moccasin" :weight bold))))
 ...
 '(rust-builtin-formatting-macro-face ((t (:foreground "orchid"))) t)
